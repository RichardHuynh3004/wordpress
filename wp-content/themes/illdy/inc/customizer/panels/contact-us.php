...
$wp_customize->add_control(
    new Illdy_Text_Custom_Control(
        ...
        array(
            ...
            'description'       => sprintf( '%s %s %s', esc_html__( 'Install', 'illdy' ), '<a href="https://wordpress.org/plugins/contact-form-7/" title="Contact Form 7" target="_blank">Contact Form 7</a>', esc_html__( 'and select a contact form to work this setting.', 'pixova-lite' ) ),
            'section'           => $prefix .'_contact_us_general',
